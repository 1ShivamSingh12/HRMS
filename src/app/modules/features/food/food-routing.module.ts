...
import { LUNCH_COUPON, PURCHASE_COUPON, REQUEST_DINNER } from 'src/app/constants/routes';
...
const routes: Routes = [
  ...
  //   path: 'al',
  //   loadChildren: () =>
  //     import('./lunch-coupon/purchase-coupon/purchase-coupon.module').then((m)=>m.PurchaseCouponModule),
  // }
];
